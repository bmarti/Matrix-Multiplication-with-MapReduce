...
cp ~/secure-mapreduce-f4/code/MapReduce_TwoSteps/unsecured/crmfs.c .
cp ~/secure-mapreduce-f4/code/MapReduce_TwoSteps/unsecured/MatrixMultiplyTwoSteps.java .
cp ~/secure-mapreduce-f4/code/MapReduce_TwoSteps/unsecured/MapTwoSteps.java .
cp ~/secure-mapreduce-f4/code/MapReduce_TwoSteps/unsecured/MapTwoSteps2.java .
cp ~/secure-mapreduce-f4/code/MapReduce_TwoSteps/unsecured/ReduceTwoSteps.java .
cp ~/secure-mapreduce-f4/code/MapReduce_TwoSteps/unsecured/ReduceTwoSteps2.java .
cp ~/secure-mapreduce-f4/code/MapReduce_TwoSteps/unsecured/launcher.sh .
...
javac -cp hadoop-common-3.0.0.jar:hadoop-mapreduce-client-core-3.0.0.jar:$(hadoop classpath):. ReduceTwoSteps12.java
...
mv ReduceTwoSteps12.class classfiles/
