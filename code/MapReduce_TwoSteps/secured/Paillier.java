...
public class Paillier {
    ...
    public void KeyGeneration(int bitLengthVal, int certainty) {
        ...
        p = new BigInteger("1000000005721");
        q = new BigInteger("1000000005713");
    ...
    public static void main(String[] str) {
        ...
        BigInteger m2 = new BigInteger("12345678");
	/* encryption*/
        BigInteger em1 = paillier.Encryption(m1);
        BigInteger em2 = paillier.Encryption(m2);
      
         /* printout encrypted text*/
        System.out.println("chiffrement de 20:  " +em1);
        System.out.println("chiffrement de 12345678:  " + em2);
        /* printout decrypted text */
        System.out.println("résultats déchiffrements: ");
        ...
        System.out.println("Test des propriétés homomorphiques: ");
        BigInteger product_em1em2 = em1.multiply(em2).mod(paillier.nsquare);
        BigInteger sum_m1m2 = m1.add(m2).mod(paillier.n);
        System.out.println("somme original: " + sum_m1m2.toString());
        System.out.println("E(m1)*E(m2) mod n^2: " + em1.multiply(em2).mod(paillier.nsquare).toString());
        System.out.println("D(E(m1)*E(m2) mod n^2): " + paillier.Decryption(product_em1em2).toString());

        /* test homomorphic properties -> D(E(m1)^m2 mod n^2) = (m1*m2) mod n */
        BigInteger expo_em1m2 = em1.modPow(m2, paillier.nsquare);
        BigInteger prod_m1m2 = m1.multiply(m2).mod(paillier.n);
        System.out.println("produit original: " + prod_m1m2.toString());
        System.out.println("E(m1)^m2 mod n^2: " + expo_em1m2.toString());
        System.out.println(" D(E(m1)^m2 mod n^2): " + paillier.Decryption(expo_em1m2).toString());
    }
}
